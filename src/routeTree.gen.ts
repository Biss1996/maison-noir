...
import { Route as ApiStkRouteImport } from './routes/api.stk'
...
const ApiStkRoute = ApiStkRouteImport.update({
  id: '/api/stk',
  path: '/api/stk',
  getParentRoute: () => rootRouteImport,
} as any)
...
export interface RootRouteChildren {
  ...
  ApiStkRoute: typeof ApiStkRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/api/stk': {
      ...
      path: '/api/stk'
      fullPath: '/api/stk'
      preLoaderRoute: typeof ApiStkRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/api/payment-status': {
      id: '/api/payment-status'
